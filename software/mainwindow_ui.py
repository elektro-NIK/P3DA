...
"background-color: rgb(0, 0, 0);")
        ...
        self.comboBox_player = QtWidgets.QComboBox(self.tab_sound)
        self.comboBox_player.setEnabled(True)
        self.comboBox_player.setObjectName("comboBox_player")
        self.gridLayout_15.addWidget(self.comboBox_player, 0, 1, 1, 3)
        ...
        self.gridLayout_15.addWidget(self.comboBox_effect_music, 0, 8, 1, 1)
        self.plainTextEdit_bitdetector = QtWidgets.QPlainTextEdit(self.tab_sound)
        self.plainTextEdit_bitdetector.setEnabled(False)
        self.plainTextEdit_bitdetector.setMaximumSize(QtCore.QSize(150, 16777215))
        ...
        self.gridLayout_15.addWidget(self.plainTextEdit_bitdetector, 1, 8, 3, 1)
        self.groupBox_low = QtWidgets.QGroupBox(self.tab_sound)
        self.groupBox_low.setEnabled(True)
        self.groupBox_low.setObjectName("groupBox_low")
        self.gridLayout_16 = QtWidgets.QGridLayout(self.groupBox_low)
        self.gridLayout_16.setObjectName("gridLayout_16")
        self.pushButton_color_low = QtWidgets.QPushButton(self.groupBox_low)
        ...
        self.gridLayout_16.addWidget(self.pushButton_color_low, 0, 3, 2, 1)
        self.spinBox_freq_low = QtWidgets.QSpinBox(self.groupBox_low)
        self.spinBox_freq_low.setMinimumSize(QtCore.QSize(75, 0))
        self.spinBox_freq_low.setMinimum(20)
        self.spinBox_freq_low.setMaximum(1000)
        self.spinBox_freq_low.setSingleStep(10)
        self.spinBox_freq_low.setProperty("value", 80)
        self.spinBox_freq_low.setObjectName("spinBox_freq_low")
        self.gridLayout_16.addWidget(self.spinBox_freq_low, 0, 1, 2, 1)
        self.label_24 = QtWidgets.QLabel(self.groupBox_low)
        self.label_24.setObjectName("label_24")
        self.gridLayout_16.addWidget(self.label_24, 0, 2, 2, 1)
        self.horizontalSlider_freq_low = QtWidgets.QSlider(self.groupBox_low)
        self.horizontalSlider_freq_low.setMinimum(20)
        self.horizontalSlider_freq_low.setMaximum(1000)
        self.horizontalSlider_freq_low.setSingleStep(10)
        self.horizontalSlider_freq_low.setPageStep(100)
        self.horizontalSlider_freq_low.setProperty("value", 80)
        self.horizontalSlider_freq_low.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider_freq_low.setObjectName("horizontalSlider_freq_low")
        self.gridLayout_16.addWidget(self.horizontalSlider_freq_low, 0, 0, 2, 1)
        self.gridLayout_15.addWidget(self.groupBox_low, 1, 0, 1, 5)
        self.groupBox_medium = QtWidgets.QGroupBox(self.tab_sound)
        self.groupBox_medium.setEnabled(True)
        self.groupBox_medium.setObjectName("groupBox_medium")
        self.gridLayout_17 = QtWidgets.QGridLayout(self.groupBox_medium)
        self.gridLayout_17.setObjectName("gridLayout_17")
        self.pushButton_color_medium = QtWidgets.QPushButton(self.groupBox_medium)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButton_color_medium.sizePolicy().hasHeightForWidth())
        self.pushButton_color_medium.setSizePolicy(sizePolicy)
        self.pushButton_color_medium.setObjectName("pushButton_color_medium")
        self.gridLayout_17.addWidget(self.pushButton_color_medium, 0, 3, 2, 1)
        self.spinBox_freq_medium = QtWidgets.QSpinBox(self.groupBox_medium)
        self.spinBox_freq_medium.setMinimumSize(QtCore.QSize(75, 0))
        self.spinBox_freq_medium.setMinimum(100)
        self.spinBox_freq_medium.setMaximum(10000)
        self.spinBox_freq_medium.setSingleStep(100)
        self.spinBox_freq_medium.setProperty("value", 500)
        self.spinBox_freq_medium.setObjectName("spinBox_freq_medium")
        self.gridLayout_17.addWidget(self.spinBox_freq_medium, 0, 1, 2, 1)
        self.label_25 = QtWidgets.QLabel(self.groupBox_medium)
        self.label_25.setObjectName("label_25")
        self.gridLayout_17.addWidget(self.label_25, 0, 2, 2, 1)
        self.horizontalSlider_freq_medium = QtWidgets.QSlider(self.groupBox_medium)
        self.horizontalSlider_freq_medium.setMinimum(100)
        self.horizontalSlider_freq_medium.setMaximum(10000)
        self.horizontalSlider_freq_medium.setSingleStep(100)
        self.horizontalSlider_freq_medium.setPageStep(1000)
        self.horizontalSlider_freq_medium.setProperty("value", 500)
        self.horizontalSlider_freq_medium.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider_freq_medium.setObjectName("horizontalSlider_freq_medium")
        self.gridLayout_17.addWidget(self.horizontalSlider_freq_medium, 0, 0, 2, 1)
        self.gridLayout_15.addWidget(self.groupBox_medium, 2, 0, 1, 5)
        self.groupBox_high = QtWidgets.QGroupBox(self.tab_sound)
        self.groupBox_high.setEnabled(True)
        self.groupBox_high.setObjectName("groupBox_high")
        self.gridLayout_18 = QtWidgets.QGridLayout(self.groupBox_high)
        self.gridLayout_18.setObjectName("gridLayout_18")
        self.pushButton_color_high = QtWidgets.QPushButton(self.groupBox_high)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_18.addWidget(self.pushButton_color_high, 0, 3, 2, 1)
        self.label_26 = QtWidgets.QLabel(self.groupBox_high)
        self.label_26.setObjectName("label_26")
        self.gridLayout_18.addWidget(self.label_26, 0, 2, 2, 1)
        self.spinBox_freq_high = QtWidgets.QSpinBox(self.groupBox_high)
        self.spinBox_freq_high.setMinimumSize(QtCore.QSize(75, 0))
        self.spinBox_freq_high.setMinimum(1000)
        self.spinBox_freq_high.setMaximum(20000)
        self.spinBox_freq_high.setSingleStep(1000)
        self.spinBox_freq_high.setProperty("value", 5000)
        self.spinBox_freq_high.setObjectName("spinBox_freq_high")
        self.gridLayout_18.addWidget(self.spinBox_freq_high, 0, 1, 2, 1)
        self.horizontalSlider_freq_high = QtWidgets.QSlider(self.groupBox_high)
        self.horizontalSlider_freq_high.setMinimum(1000)
        self.horizontalSlider_freq_high.setMaximum(20000)
        self.horizontalSlider_freq_high.setSingleStep(1000)
        self.horizontalSlider_freq_high.setPageStep(5000)
        self.horizontalSlider_freq_high.setProperty("value", 5000)
        self.horizontalSlider_freq_high.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider_freq_high.setObjectName("horizontalSlider_freq_high")
        self.gridLayout_18.addWidget(self.horizontalSlider_freq_high, 0, 0, 2, 1)
        self.gridLayout_15.addWidget(self.groupBox_high, 3, 0, 1, 5)
        ...
        self.spinBox_ch6 = QtWidgets.QSpinBox(self.groupBox_setup_ext)
        self.spinBox_ch6.setMaximum(6)
        self.spinBox_ch6.setProperty("value", 6)
        self.spinBox_ch6.setObjectName("spinBox_ch6")
        self.gridLayout_19.addWidget(self.spinBox_ch6, 11, 1, 1, 1)
        self.spinBox_ch1 = QtWidgets.QSpinBox(self.groupBox_setup_ext)
        self.spinBox_ch1.setMaximum(6)
        self.spinBox_ch1.setProperty("value", 1)
        self.spinBox_ch1.setObjectName("spinBox_ch1")
        self.gridLayout_19.addWidget(self.spinBox_ch1, 1, 1, 1, 1)
        self.label_29 = QtWidgets.QLabel(self.groupBox_setup_ext)
        self.label_29.setObjectName("label_29")
        self.gridLayout_19.addWidget(self.label_29, 5, 0, 1, 1)
        self.label_5 = QtWidgets.QLabel(self.groupBox_setup_ext)
        self.label_5.setObjectName("label_5")
        self.gridLayout_19.addWidget(self.label_5, 11, 0, 1, 1)
        self.label_28 = QtWidgets.QLabel(self.groupBox_setup_ext)
        self.label_28.setObjectName("label_28")
        self.gridLayout_19.addWidget(self.label_28, 7, 0, 1, 1)
        self.label_6 = QtWidgets.QLabel(self.groupBox_setup_ext)
        self.label_6.setObjectName("label_6")
        self.gridLayout_19.addWidget(self.label_6, 9, 0, 1, 1)
        self.label_27 = QtWidgets.QLabel(self.groupBox_setup_ext)
        self.label_27.setObjectName("label_27")
        self.gridLayout_19.addWidget(self.label_27, 3, 0, 1, 1)
        self.spinBox_ch4 = QtWidgets.QSpinBox(self.groupBox_setup_ext)
        self.spinBox_ch4.setMaximum(6)
        self.spinBox_ch4.setProperty("value", 4)
        self.spinBox_ch4.setObjectName("spinBox_ch4")
        self.gridLayout_19.addWidget(self.spinBox_ch4, 7, 1, 1, 1)
        self.label_34 = QtWidgets.QLabel(self.groupBox_setup_ext)
        self.label_34.setObjectName("label_34")
        self.gridLayout_19.addWidget(self.label_34, 9, 2, 1, 1)
        self.spinBox_ch2 = QtWidgets.QSpinBox(self.groupBox_setup_ext)
        self.spinBox_ch2.setMaximum(6)
        self.spinBox_ch2.setProperty("value", 2)
        self.spinBox_ch2.setObjectName("spinBox_ch2")
        self.gridLayout_19.addWidget(self.spinBox_ch2, 3, 1, 1, 1)
        self.label_32 = QtWidgets.QLabel(self.groupBox_setup_ext)
        self.label_32.setObjectName("label_32")
        self.gridLayout_19.addWidget(self.label_32, 5, 2, 1, 1)
        self.label_35 = QtWidgets.QLabel(self.groupBox_setup_ext)
        self.label_35.setObjectName("label_35")
        self.gridLayout_19.addWidget(self.label_35, 11, 2, 1, 1)
        self.label_36 = QtWidgets.QLabel(self.groupBox_setup_ext)
        self.label_36.setObjectName("label_36")
        self.gridLayout_19.addWidget(self.label_36, 1, 3, 1, 1)
        self.label_33 = QtWidgets.QLabel(self.groupBox_setup_ext)
        self.label_33.setObjectName("label_33")
        self.gridLayout_19.addWidget(self.label_33, 7, 2, 1, 1)
        self.spinBox_ch3 = QtWidgets.QSpinBox(self.groupBox_setup_ext)
        self.spinBox_ch3.setMaximum(6)
        self.spinBox_ch3.setProperty("value", 3)
        self.spinBox_ch3.setObjectName("spinBox_ch3")
        self.gridLayout_19.addWidget(self.spinBox_ch3, 5, 1, 1, 1)
        ...
        self.gridLayout_19.addWidget(self.spinBox_update, 1, 4, 1, 1)
        self.label_31 = QtWidgets.QLabel(self.groupBox_setup_ext)
        self.label_31.setObjectName("label_31")
        self.gridLayout_19.addWidget(self.label_31, 3, 2, 1, 1)
        ...
        self.gridLayout_19.addWidget(self.pushButton_zones, 0, 0, 1, 3)
        self.spinBox_ch5 = QtWidgets.QSpinBox(self.groupBox_setup_ext)
        self.spinBox_ch5.setMaximum(6)
        self.spinBox_ch5.setProperty("value", 5)
        self.spinBox_ch5.setObjectName("spinBox_ch5")
        self.gridLayout_19.addWidget(self.spinBox_ch5, 9, 1, 1, 1)
        self.label_37 = QtWidgets.QLabel(self.groupBox_setup_ext)
        self.label_37.setObjectName("label_37")
        self.gridLayout_19.addWidget(self.label_37, 1, 5, 1, 1)
        self.label_30 = QtWidgets.QLabel(self.groupBox_setup_ext)
        self.label_30.setObjectName("label_30")
        self.gridLayout_19.addWidget(self.label_30, 1, 2, 1, 1)
        self.pushButton_on_off = QtWidgets.QPushButton(self.groupBox_setup_ext)
        self.pushButton_on_off.setCheckable(True)
        self.pushButton_on_off.setObjectName("pushButton_on_off")
        self.gridLayout_19.addWidget(self.pushButton_on_off, 0, 3, 1, 3)
        self.label_38 = QtWidgets.QLabel(self.groupBox_setup_ext)
        self.label_38.setObjectName("label_38")
        self.gridLayout_19.addWidget(self.label_38, 3, 3, 1, 1)
        ...
        self.gridLayout_19.addWidget(self.comboBox_effect_backlight, 3, 4, 1, 1)
        self.label_39 = QtWidgets.QLabel(self.groupBox_setup_ext)
        self.label_39.setObjectName("label_39")
        self.gridLayout_19.addWidget(self.label_39, 5, 3, 1, 1)
        ...
        self.gridLayout_19.addWidget(self.spinBox_effect, 5, 4, 1, 1)
        self.label_40 = QtWidgets.QLabel(self.groupBox_setup_ext)
        self.label_40.setObjectName("label_40")
        self.gridLayout_19.addWidget(self.label_40, 5, 5, 1, 1)
        self.gridLayout_4.addWidget(self.groupBox_setup_ext, 0, 0, 1, 2)
        ...
        self.label_23.setBuddy(self.comboBox_player)
        self.label_24.setBuddy(self.pushButton_color_low)
        self.label_25.setBuddy(self.pushButton_color_medium)
        self.label_26.setBuddy(self.pushButton_color_high)
        self.label_41.setBuddy(self.comboBox_effect_music)
        self.label_4.setBuddy(self.spinBox_ch1)
        self.label_29.setBuddy(self.spinBox_ch3)
        self.label_5.setBuddy(self.spinBox_ch6)
        self.label_28.setBuddy(self.spinBox_ch4)
        self.label_6.setBuddy(self.spinBox_ch5)
        self.label_27.setBuddy(self.spinBox_ch2)
        ...
        self.horizontalSlider_freq_low.valueChanged['int'].connect(self.spinBox_freq_low.setValue)
        self.spinBox_freq_low.valueChanged['int'].connect(self.horizontalSlider_freq_low.setValue)
        self.horizontalSlider_freq_medium.valueChanged['int'].connect(self.spinBox_freq_medium.setValue)
        self.spinBox_freq_medium.valueChanged['int'].connect(self.horizontalSlider_freq_medium.setValue)
        self.horizontalSlider_freq_high.valueChanged['int'].connect(self.spinBox_freq_high.setValue)
        self.spinBox_freq_high.valueChanged['int'].connect(self.horizontalSlider_freq_high.setValue)
        ...
        MainWindow.setTabOrder(self.tabWidget, self.pushButton_color)
        ...
        MainWindow.setTabOrder(self.pushButton_last20, self.plainTextEdit_input1)
        MainWindow.setTabOrder(self.plainTextEdit_input1, self.comboBox_effect1)
        ...
        MainWindow.setTabOrder(self.pushButton_effect1, self.plainTextEdit_input2)
        MainWindow.setTabOrder(self.plainTextEdit_input2, self.comboBox_effect2)
        ...
        MainWindow.setTabOrder(self.pushButton_effect2, self.plainTextEdit_input3)
        MainWindow.setTabOrder(self.plainTextEdit_input3, self.comboBox_effect3)
        ...
        MainWindow.setTabOrder(self.pushButton_effect3, self.plainTextEdit_input4)
        MainWindow.setTabOrder(self.plainTextEdit_input4, self.comboBox_effect4)
        ...
        MainWindow.setTabOrder(self.pushButton_effect4, self.comboBox_player)
        MainWindow.setTabOrder(self.comboBox_player, self.horizontalSlider_freq_low)
        MainWindow.setTabOrder(self.horizontalSlider_freq_low, self.spinBox_freq_low)
        MainWindow.setTabOrder(self.spinBox_freq_low, self.pushButton_color_low)
        MainWindow.setTabOrder(self.pushButton_color_low, self.horizontalSlider_freq_medium)
        MainWindow.setTabOrder(self.horizontalSlider_freq_medium, self.spinBox_freq_medium)
        MainWindow.setTabOrder(self.spinBox_freq_medium, self.pushButton_color_medium)
        MainWindow.setTabOrder(self.pushButton_color_medium, self.horizontalSlider_freq_high)
        MainWindow.setTabOrder(self.horizontalSlider_freq_high, self.spinBox_freq_high)
        MainWindow.setTabOrder(self.spinBox_freq_high, self.pushButton_color_high)
        MainWindow.setTabOrder(self.pushButton_color_high, self.comboBox_effect_music)
        MainWindow.setTabOrder(self.comboBox_effect_music, self.plainTextEdit_bitdetector)
        MainWindow.setTabOrder(self.plainTextEdit_bitdetector, self.pushButton_zones)
        MainWindow.setTabOrder(self.pushButton_zones, self.pushButton_on_off)
        MainWindow.setTabOrder(self.pushButton_on_off, self.spinBox_ch1)
        MainWindow.setTabOrder(self.spinBox_ch1, self.spinBox_ch2)
        MainWindow.setTabOrder(self.spinBox_ch2, self.spinBox_ch3)
        MainWindow.setTabOrder(self.spinBox_ch3, self.spinBox_ch4)
        MainWindow.setTabOrder(self.spinBox_ch4, self.spinBox_ch5)
        MainWindow.setTabOrder(self.spinBox_ch5, self.spinBox_ch6)
        MainWindow.setTabOrder(self.spinBox_ch6, self.spinBox_update)
        MainWindow.setTabOrder(self.spinBox_update, self.comboBox_effect_backlight)
        MainWindow.setTabOrder(self.comboBox_effect_backlight, self.spinBox_effect)
        MainWindow.setTabOrder(self.spinBox_effect, self.comboBox_device)
...
"#000000"))
        ...
        self.label_23.setText(_translate("MainWindow", "Player"))
        self.plainTextEdit_bitdetector.setPlainText(_translate("MainWindow", "#ff0000\n"
"#00ff00\n"
"#0000ff"))
        self.groupBox_low.setTitle(_translate("MainWindow", "Low"))
        self.pushButton_color_low.setText(_translate("MainWindow", "#ff0000"))
        self.label_24.setText(_translate("MainWindow", "Hz"))
        self.groupBox_medium.setTitle(_translate("MainWindow", "Medium"))
        self.pushButton_color_medium.setText(_translate("MainWindow", "#00ff00"))
        self.label_25.setText(_translate("MainWindow", "Hz"))
        self.groupBox_high.setTitle(_translate("MainWindow", "High"))
        self.pushButton_color_high.setText(_translate("MainWindow", "#0000ff"))
        self.label_26.setText(_translate("MainWindow", "Hz"))
        self.label_41.setText(_translate("MainWindow", "Effect"))
        ...
        self.label_4.setText(_translate("MainWindow", "1st zone"))
        self.label_29.setText(_translate("MainWindow", "3rd zone"))
        self.label_5.setText(_translate("MainWindow", "6th zone"))
        self.label_28.setText(_translate("MainWindow", "4th zone"))
        self.label_6.setText(_translate("MainWindow", "5th zone"))
        self.label_27.setText(_translate("MainWindow", "2nd zone"))
        self.label_34.setText(_translate("MainWindow", "chanel"))
        self.label_32.setText(_translate("MainWindow", "chanel"))
        self.label_35.setText(_translate("MainWindow", "chanel"))
        self.label_36.setText(_translate("MainWindow", "Update interval"))
        self.label_33.setText(_translate("MainWindow", "chanel"))
        self.label_31.setText(_translate("MainWindow", "chanel"))
        self.pushButton_zones.setText(_translate("MainWindow", "Set zones"))
        self.label_37.setText(_translate("MainWindow", "ms"))
        self.label_30.setText(_translate("MainWindow", "chanel"))
        self.pushButton_on_off.setText(_translate("MainWindow", "On/off"))
        self.label_38.setText(_translate("MainWindow", "Effect"))
        self.label_39.setText(_translate("MainWindow", "Effect time"))
